...
typedef enum { AT_COMMANDS_TABLE(AT_CMD_AS_ENUM) } at_cmd_t;

enum msg_status_t { MSG_STAT_REC_UNREAD, MSG_STAT_REC_READ, MSG_STAT_STO_UNSENT, MSG_STAT_STO_SENT, MSG_STAT_ALL };
