...
FUNCTION(ShowAstBuildOptSum AST_HEADERS_SUBDIR)
    ...
    IF(AST_BUILDOPT_SUM_COMPILE AND AST_BUILDOPT_SUM_RUN)
        ...
        IF("${AST_BUILDOPT_SUM}" MATCHES "^[0123456789abcdef]+$")
            ...
            MESSAGE(STATUS "AST_BUILDOPT_SUM=${AST_BUILDOPT_SUM}")
        ELSE()
            MESSAGE(FATAL_ERROR "Wrong AST_BUILDOPT_SUM: ${AST_BUILDOPT_SUM}")
        ENDIF()
    ELSE()
        MESSAGE(FATAL_ERROR "Asterisk: Unknown value of AST_BUILDOPT_SUM")
    ENDIF()
ENDFUNCTION()
